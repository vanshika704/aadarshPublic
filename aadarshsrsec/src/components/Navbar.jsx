...
//     path: "/dossier",
//     items: [
//       // NOTE: Ensure these files exist in your 'public/dossier' folder
...
//                             // Logic: Check if path ends in .pdf
...
//                     <div className={`px-4 text-xs font-bold ${ACCENT_COLOR} uppercase tracking-wider`}>
//                       {menu.title}
//                     </div>
